 ...
 */
final class SpotifyAPIWrapper: ObservableObject {
    ...
    static let authURLNotif = NSNotification.Name.init("receivedSpotifyAuthURL")
    ...
    let api = SpotifyAPI(
        authorizationManager: AuthorizationCodeFlowManager(
            clientId: SpotifyAPIWrapper.clientId,
            clientSecret: SpotifyAPIWrapper.clientSecret
        )
    )
    ...
    init() {
        ...
        self.api.apiRequestLogger.logLevel = .info
    ...
    func authorize() {
        ...
        let url = api.authorizationManager.makeAuthorizationURL(
            redirectURI: SpotifyAPIWrapper.loginCallbackURL,
            showDialog: true,
